...
catch (Exception $e) { header('Location: /homepage.html'); }
...
<body>
  ...
  <nav v class="navbar navbar-expand-md fixed-top bg-dark">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#" id="letter">register</a>
          </li>        
          <li class="nav-item">
            <a class="nav-link" href="#" id="letteron">logout</a>
          </li>   
        </ul>
      </div>
    </div>
...
<h5 class="widget-title">PHPExperts.pro<span></span></h5>
<p>capacitacion para programadores novatos en toda colombia, formando los nuevos desarrolladores de software del mañana </p>
</div>
</div>
...
<li>
<div class="thumb-content"><a href="#.">ninguno</a></div>	
</li>
</ul>
</div>
</div>
...
<div class="col-xs-12 col-sm-6 col-md-3">
<div class="widget no-box">
<h5 class="widget-title">Additional Information<span></span></h5>
<p>Get access to your full Training and Marketing Suite.</p>
<a class="btn" href="" target="_blank">button</a>
</div>
</div>
...
<p><a href="mailto:info@domain.com" title="glorythemes">projects@email.com</a></p>
...
<p>PHPExperts.pro © 2022. All rights reserved.</p>
</div>
</div>
</div>
</div>
